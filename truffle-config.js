 ...
 *
 * This file is named `truffle-config` for Windows users because `truffle.js`
 * conflicts with the `truffle` command on that platform. (You can also
 * use this file on Linux and Mac.)
 *
